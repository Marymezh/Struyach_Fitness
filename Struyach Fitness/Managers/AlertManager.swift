...
final class AlertManager {
    ...
    public var buttonColor = ColorManager.shared.appColor
    ...
    func showAlert(title: String, message: String, cancelAction: String, completion: ((UIAlertAction) -> Void)? = nil) {
        DispatchQueue.main.async {
            ...
            alert.view.tintColor = self.buttonColor
...
extension UIApplication {
    var topViewController: UIViewController? {
        return windows.first { $0.isKeyWindow }?.rootViewController?.topViewController
    }
}
