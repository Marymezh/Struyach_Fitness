...
struct ProgramDescriptionStorage {
   static let programArray = [
    ...
    ProgramDescription(programName: K.pelvicPower, programDetail: "Tone and strengthen your pelvic muscles with our 10 high-intensity workouts".localized(), cellImage: "badass"),
    ProgramDescription(programName: K.bellyBurner, programDetail: "Get rid of stubborn belly fat and achieve a leaner, fitter body with our 10 high-intensity workouts".localized(), cellImage: "hardpress")
   ]
}
